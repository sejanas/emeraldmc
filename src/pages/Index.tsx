      ...
      <section className="relative overflow-hidden bg-section-gradient">
        <div className="container grid items-center gap-8 py-20 md:grid-cols-2 md:py-28">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.2 }}>
            <img src={heroImg} alt="Shifa's Mainland Healthcare - ISO certified diagnostic laboratory in Sri Vijaya Puram" className="w-full rounded-2xl card-shadow object-cover" loading="eager" fetchPriority="high" />
          </motion.div>
        </div>
      </section>
