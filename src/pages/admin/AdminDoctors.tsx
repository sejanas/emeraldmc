...
const AdminDoctors = () => {
  ...
  const openNew = () => {
    setEditing(null);
    setForm({ name: "", slug: "", specialization: "", qualification: "", experience_years: 0, bio: "", profile_image: "", display_order: items.length });
    setOpen(true);
  };
  ...
  return (
    <div>
      ...
      {items.length === 0 && <p className="py-8 text-center text-muted-foreground">No doctors yet.</p>}
